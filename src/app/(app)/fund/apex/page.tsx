export default function FundApexPage() {
  return <PlaceholderPage title="Apex Reports" description="NAV tracking, fund-level financials from Apex 200/300 series reports — coming in Phase 2." />;
}
